...
- v0.1 clear path set: light source, mirror, wall, target, reset, next level, level select.
- Local progress save.
- Prism and concentrator remain placeholders.

## Out Of Scope

- Prism splitting, concentrator energy recovery, portable concentrator, hint path system, ads, login, ranking, payment, backend, sharing incentives.
...
- `pnpm --dir minigame run build` succeeds.
